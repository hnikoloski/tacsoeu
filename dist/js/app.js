...
/* harmony import */ var _scripts_move_it_on_mob__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./scripts/move-it-on-mob */ "./src/scripts/move-it-on-mob.js");
/* harmony import */ var _scripts_move_it_on_mob__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(_scripts_move_it_on_mob__WEBPACK_IMPORTED_MODULE_12__);
...
jQuery(document).ready(function ($) {
  ...
  $(".site-footer .site-info .footer-links-col ul li a, .site-footer .site-info .footer-quick-links-wrapper ul li a").addClass("fancy-hover fancy-hover-lblue"); //Cookie Functions
  ...
  if (getCookie("daViPomozam") == "brojceOdOvaDanImate") {
    ...
    $("body").append('<div id="cookie-notice" class="animated fadeInLeft"> <p>Our Website uses cookies to improve your experience. Read more at our <a href="/privacy-policy">Privacy Policy</a>.</p> <div class="buttons-wrapper"> <a href="#!" class="accept">Accept</a> <a href="#!" class="decline">Decline</a></div> </div>');
  ...
  $('.site-footer .site-info .footer-links-col ul li a').each(function (index, value) {
    var getLength = $(this).text().length;
...
jQuery(document).ready(function ($) {
  if ($(".story-archive").length) {
    ...
    var getStories = function getStories() {
      axios.get("/wp-json/wp/v2/story?_embed&per_page=100").then(function (response) {
        var html = response.data.map(function (story) {
          ...
          if (countryTotal > 1) {
            ...
            countryTag = " <span class=\"additional-countries\">+ ".concat(countryTotal, " </span></div>");
          } else {
            countryTag = "</div>";
          }
