...
function starter_scripts()
{
    ...
    wp_register_style('fa-style', 'https://pro.fontawesome.com/releases/v5.10.0/css/all.css', [], 1, 'all');
    wp_enqueue_style('fa-style');


    wp_register_script('app', get_template_directory_uri() . '/dist/js/app.js#asyncload', ['jquery'], 1, true);
...
// Remove Update notice for specific plugins
